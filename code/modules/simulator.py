...
class Simulator(ABC):
    ...
    def initialize(self, initial_state: Opinion or None = None, initialize_with_prejudice: bool = False) -> None:  # TODO: implement sampler
    ...
    def run(self, horizon: int, initialize: bool = True, initial_state: Opinion or None = None) -> None:
        if initialize:
